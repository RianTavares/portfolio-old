const language = [
  // Português
  {
    ...
    "section3": {
      ...
      "job0": {
        "time": "03.2020 - Hoje",
        "details": "Atualmente como desenvolvedor FullStack pleno no time de consumidor contribuo também na criação de entidades, rotas, validação de dados e integração ao front-end. Tenho atuado fortemente na otimização de processos, na atualização do gerenciador de vitrines, criado por nós utilizando ReactJs, e na experiência de barreira das matérias. Atualmente nosso gerenciador de vitrines já serve todo nosso conteúdo de revistas e jornais digitais. Estamos focados agora na venda do impresso utilizando o mesmo sistema.",
  ...
  // English
  {
    ...
    "section3": {
      ...
      "job0": {
        ...
        "details": "Currently, as a FullStack Engineer in the consumer team, I also contribute to the creation of entities, routes, data validation and integration to the front-end. I have been acting strongly in the optimization of processes, in the update of the showcase manager, created by us using ReactJs, and in the Paywall experience of our products. Currently our showcase manager already serves all of our digital magazine and news portal content. We are now focused on selling the newspaper using the same system.",
